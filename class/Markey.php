...
class Markey{
    ...
    public function reservarCama($idCama, $observacion){
        //cambia  el estado de una cama en Markey. Si la operación es exitosa (status code 200), devuelve 1, sino 0
        $conexion = curl_init();

        $idEstado = 6; //RESERVADA
        
        $urlServicio = 'https://clinicaadventista.markey.com.ar/APIMarkeyCAB/api/camas/cambiarEstado?APIKey=d5e75bde-205b-4468-86ec-67e7160bad2e&id_cama='.$idCama.'&id_estado='.$idEstado.'&observaciones='.rawurlencode($observacion);
